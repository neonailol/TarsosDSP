...
public class AudioDispatcher implements Runnable {
     ...
     * <p>
     * The behavior for the first and last buffer is defined by their corresponding the zero pad settings. The method also handles the
     * case if
    ...
    private int readNextAudioBlock() throws IOException {
        ...
        if (endOfStream) {
            ...
            throw new IOException(String.format(
                ...
                + "to the expected amount of bytes(%d).",
                totalBytesRead,
                bytesToRead
            ));
        }
