    ...
    protected void removeDuplicates() {
        ...
        for (AgentList ptr = this; ptr.ag != null; ptr = ptr.next) {
            ...
            for (AgentList ptr2 = ptr.next; ptr2.ag != null; ptr2 = ptr2.next) {
                ...
                if (Math.abs(ptr.ag.beatTime - ptr2.ag.beatTime) > thresholdBT) { continue; }
                if (ptr.ag.phaseScore < ptr2.ag.phaseScore) {
                    ptr.ag.phaseScore = -1.0;    // flag for deletion
                    if (ptr2.ag.topScoreTime < ptr.ag.topScoreTime) { ptr2.ag.topScoreTime = ptr.ag.topScoreTime; }
                    break;
                } else {
                    ptr2.ag.phaseScore = -1.0;    // flag for deletion
                    if (ptr.ag.topScoreTime < ptr2.ag.topScoreTime) { ptr.ag.topScoreTime = ptr2.ag.topScoreTime; }
                }
            }
        }
    ...
    public Agent bestAgent() {
        ...
        if (debug) {
            if (bestAg != null) {
                ...
                // bestAg.events.print();
            } else { System.out.println("No surviving agent - beat tracking failed"); }
        }
        return bestAg;
    } // bestAgent()
