...
public class AudioDispatcherFactory {
     ...
     *
     * @param sampleRate      The <b>requested</b> sample rate must be supported by the capture device. Nonstandard sample
    ...
    public static AudioDispatcher fromByteArray(
        final byte[] byteArray, final AudioFormat audioFormat,
     ...
     */
    public static AudioDispatcher fromPipe(
        final String source,
     ...
     * @throws UnsupportedAudioFileException If the audio format is not supported.
     */
    public static AudioDispatcher fromFloatArray(
