    ...
    public static void main(String[] args) throws UnsupportedAudioFileException, IOException {
        ...
        d.addAudioProcessor(new AudioProcessor() {
            ...
            public boolean process(AudioEvent audioEvent) {
                ...
                //float offset = (amplitudes[maxIndex+1] - amplitudes[maxIndex-1])/( 2*(2 * amplitudes[maxIndex] - amplitudes[maxIndex+1]
                // - amplitudes[maxIndex-1] ));
                //offset/=2.0f;
                ...
                System.out.println(adjustedBinIndex * 44100 / 1024.0f +
                                   " Hz in stead of " +
                                   maxIndex * 44100 / 1024.0f +
                                   " Hz" +
                                   " phase: " +
                                   spp.getFrequencyEstimates()[maxIndex]);
