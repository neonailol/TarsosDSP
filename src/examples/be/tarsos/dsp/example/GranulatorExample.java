    ...
    public GranulatorExample() {
        ...
        timeStretchSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                ...
                if (granulator != null) { granulator.setTimestretchFactor(currentFactor); }
            }
        });
        ...
        pitchShiftSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                ...
                if (granulator != null) { granulator.setPitchShiftFactor(currentFactor); }
            }
        });
        ...
        grainIntervallSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                ...
                if (granulator != null) { granulator.setGrainInterval(grainInterval); }
            }
        });
        ...
        grainSizeSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                ...
                if (granulator != null) { granulator.setGrainSize(grainSize); }
            }
        });
        ...
        grainRandomnesslSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                ...
                if (granulator != null) { granulator.setGrainRandomness(grainRandomness); }
            }
        });
        ...
        positionSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg0) {
                ...
                if (granulator != null) { granulator.setPosition(position); }
            }
        });
