...
public class OnsetDetector extends JFrame implements OnsetHandler {
    ...
    public OnsetDetector() {
        ...
        inputPanel.addPropertyChangeListener(
            "mixer",
    ...
    private void addClips() {
        String[] clips = {"50863__chipfork__Echopop.wav", "50771__Digital_System__BOOM_reverb.wav", "30667__HardPCM__HardBassDrum001.wav"
            , "30669__HardPCM__HardKick002.wav", "33637__HerbertBoland__CinematicBoomNorm.wav"};
