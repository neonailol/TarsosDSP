...
public class Resynthesizer {
    ...
    private static class CommandLineResynthesizer {
        ...
        private void combineTwoMonoAudioFilesInTwoChannels(
            String first,
            String second,
            String outputFile
        ...
        private void run(String[] args) throws UnsupportedAudioFileException, IOException, IllegalArgumentException,
            ...
            if (args.length == 3 && args[0].equalsIgnoreCase("--detector")) {
                ...
                SharedCommandLineUtilities.printLine();
                System.err.println("Current error:");
                System.err.println("\tThe command expects the options in the specified order, the current command is not parsed " +
                                   "correctly!");
                return;
            }
