...
public class DissonanceExample extends JFrame {
        ...
        if (currentFrame < spectalInfo.size()) {
            ...
            for (SpectralPeak peak : peaks) {
                String message = String.format(
                    ...
                    peak.getMagnitude(),
                    peak.getFrequencyInHertz() / peak.getRefFrequencyInHertz()
                );
                sb.append(message);
    ...
    public static void main(String[] args) throws InvocationTargetException, InterruptedException, UnsupportedAudioFileException,
        LineUnavailableException, IOException {
        SwingUtilities.invokeAndWait(new Runnable() {
            @Override
            public void run() {
                DissonanceExample frame = new DissonanceExample(
                    "/home/joren/Dropbox/UGent/LaTeX/Articles/2014.Sethares-Theory/etc/octave/flute-test/");
                frame.pack();
