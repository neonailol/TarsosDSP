...
public class Catify {
    ...
    public static void main(String[] args) throws InvalidMidiDataException, IOException, UnsupportedAudioFileException,
    ...
    private static void printDescription() {
        ...
        System.err.println(
            "\tCatifys the midi file defined in input.mid. It renders the midi with audio samples in either a directory or using a cat " +
            "sample.");
    }
